	...
	for i in ingredients[1]:
		...
		if category == 'Dairy, Eggs and Milk' and 'eggs' not in i:
			if 'milk' in i and 'almond' not in i and 'soy' not in i and 'coconut' not in i and 'oat' not in i:
				...
				lactose_free_ingredients.append('dairy-free milk of choice')
				...
				print(i, ' became ', 'dairy-free alternative for ', i, ' of choice')
				lactose_free_ingredients.append('dairy-free alternative for ', i, ' of choice')
